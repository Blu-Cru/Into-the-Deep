...
public class Extension implements BluSubsystem, Subsystem {
    public static double
            kP = 0.26, kI = 0.0, kD = 0.012 , kFAngle = 0.18, tolerance = 0.0, kPStatic = 0.005,
            MIN_INCHES = 0.0, MAX_INCHES = 26.1, MAX_HORIZ_EXTENSION = 17.0, // pid distance to change based on input
